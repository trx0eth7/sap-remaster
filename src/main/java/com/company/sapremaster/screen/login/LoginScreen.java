package com.company.sapremaster.screen.login;
...
public class LoginScreen extends Screen {
    ...
    @Subscribe("linkButtonField")
    public void onLinkButtonFieldClick(Button.ClickEvent event) {
        notifications.create(Notifications.NotificationType.HUMANIZED)
                .withCaption("Кнопка")
                .withDescription("Кнопка нажата")
                .show();
    }
